...
@implementation ADMCustomEvent {
    ...
    ADMCustomEventAppOpen *admAppOpen;
}
...
- (void)loadAppOpenAdForAdConfiguration:(GADMediationAppOpenAdConfiguration *)adConfiguration
    ...
    admAppOpen = [[ADMCustomEventAppOpen alloc] init];
    [admAppOpen loadAppOpenAdForAdConfiguration:adConfiguration completionHandler:completionHandler];
}
