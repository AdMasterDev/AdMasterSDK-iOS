...
static NSString *const ADMCustomEventAdapterVersion = @"2.0.1.1";

/// key for appID
static NSString *const ADMCustomEventAppID = @"app_id";

/// key for adUnitID
static NSString *const ADMCustomEventAdUnitID = @"ad_unit_id";

/// key for test mode
static NSString *const ADMCustomEventIsTest = @"test";

/// key for mock mode
static NSString *const ADMCustomEventIsMock = @"mock";
